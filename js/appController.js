  ...
  function ControllerViewModel() {
    ...
    let navData = [
      ...
      },
      {
        ...
        detail: {
          label: 'Admin Movies',
          iconClass: 'oj-ux-ico-administration',
        },
      },
      {
        path: 'movies',
        detail: { label: 'Movies Food', iconClass: 'oj-ux-ico-menu-advanced' },
      },

      {
        path: 'statistics',
        detail: { label: 'Statistics', iconClass: 'oj-ux-ico-status' },
      },
      {
        path: 'about',
    ...
    this.logoUrl = ko.observable('logo.jpg')
    this.appName = ko.observable('Cinema Movies')
    // User Info used in Global Navigation area
    this.userLogin = ko.observable('marius.man@ulbsibiu.ro')
